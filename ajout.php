<?php
   ...
   $requete= "INSERT INTO adherent (nomAdh, prenomAdh, adresseAdh, villeAdh, cpAdh, niveauAdh,typeAdh)

              VALUES('".$_POST['nom']."','".$_POST['prenom']."','".$_POST['adresse']."','".$_POST['ville']."','".$_POST['cp']."','".$_POST['niveau']."','".$_POST['type']."');
...
<body>
  ...
  <h2>Vous avez ajouté un adhérent!!!</h2>
